...
const char *COMMAND_TOPIC             = "furnace/wt32eth01/commands";              // The MQTT topic where the IP address will be published to.
const char *PUBLISH_TOPIC             = "furnace/wt32eth01/publishCount";          // The MQTT topic where the publish count will be published to.
const char *CALLBACK_COUNT_TOPIC      = "furnace/wt32eth01/networkCallbackCount";  // The MQTT topic where the network callback count will be published to.
const char *MQTT_CALLBACK_COUNT_TOPIC = "furnace/wt32eth01/mqttCallbackCount";     // The MQTT topic where the MQTT callback count will be published to.
const char *MAC_TOPIC                 = "furnace/wt32eth01/mac";                   // The MQTT topic where the MAC address will be published to.
const char *IP_TOPIC                  = "furnace/wt32eth01/ip";                    // The MQTT topic where the IP address will be published to.
const char *DS18_TEMP_C_TOPIC         = "furnace/wt32eth01/ds18b20-00/tempC";      // The MQTT topic where the Celsius temperature will be published to.
const char *DS18_TEMP_F_TOPIC         = "furnace/wt32eth01/ds18b20-00/tempF";      // The MQTT topic where the Fahrenheit temperature will be published to.
