...
const char *DS18_TEMP_C_TOPIC         = "furnace/wt32eth01/ds18b20/tempC";         // The MQTT topic where the Celsius temperature will be published to.
const char *DS18_TEMP_F_TOPIC         = "furnace/wt32eth01/ds18b20/tempF";         // The MQTT topic where the Fahrenheit temperature will be published to.
